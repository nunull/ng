...
var _nunull$ng$Network$fetchReddit = function (sub) {
	return A2(
		...
		A2(
			...
			A2(_elm_lang$core$Basics_ops['++'], sub, '.json')),
		A2(
			_elm_lang$core$Json_Decode$at,
			_elm_lang$core$Native_List.fromArray(
				['data', 'children']),
			_elm_lang$core$Json_Decode$list(
				A2(
					...
					A5(
						...
						F4(
							function (title, url, permalink, created) {
								return {
									name: title,
									url: url,
									commentsUrl: A2(_elm_lang$core$Basics_ops['++'], 'https://www.reddit.com', permalink),
									date: _elm_lang$core$Date$fromTime(created * 1000),
									source: 'r',
									channel: sub
								};
							}),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('loading-indicator'),
						_elm_lang$html$Html_Attributes$hidden(
						_elm_lang$core$Basics$not(model.loading))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
						...
						A2(
							...
							function (item) {
								return _elm_lang$core$Time$inMilliseconds(
									_elm_lang$core$Date$toTime(item.date));
							},
							model.items))))
			]));
};
